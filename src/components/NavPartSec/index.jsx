...
const index = ()=>{
  window.addEventListener("scroll", function () {
    ...
    search.classList.toggle("active", window.scrollY > 30)
  })
  return(
    <>
    <div className="nav-part-sec d-flex justify-content-center align-items-center" id="par">
    <ul className="maincha ">
    <li className="maincha-item">
    ...
    <Link to='/' className="nav-link mt-4">Overview</Link>
    </li>
    <li className="maincha-item">
    ...
    <Link to='/repositories' className="nav-link mt-4">Repositories</Link>
    </li>
    <li className="maincha-item">
    ...
    <Link to='/project' className="nav-link mt-4">Projects</Link>
    </li>
    <li className="maincha-item">
    ...
    <Link to='/packages' className="nav-link mt-4">Packages</Link>
    </li>
    <li className="maincha-item">
    <i className="fa-regular fa-star"></i>
    <Link to='/starts' className="nav-link mt-4">Starts</Link>
    </li>
    </ul>
    </div>
    </>
